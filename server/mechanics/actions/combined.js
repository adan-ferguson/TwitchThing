...
import modifyEffect from './common/modifyEffect.js'
...
export default { applyStatusEffect: { def: applyStatusEffect, id: 'applyStatusEffect', group: 'common' },attack: { def: attack, id: 'attack', group: 'common' },breakItem: { def: breakItem, id: 'breakItem', group: 'common' },dealDamage: { def: dealDamage, id: 'dealDamage', group: 'common' },gainHealth: { def: gainHealth, id: 'gainHealth', group: 'common' },modifyAbility: { def: modifyAbility, id: 'modifyAbility', group: 'common' },modifyEffect: { def: modifyEffect, id: 'modifyEffect', group: 'common' },pass: { def: pass, id: 'pass', group: 'common' },removeStatusEffect: { def: removeStatusEffect, id: 'removeStatusEffect', group: 'common' },takeDamage: { def: takeDamage, id: 'takeDamage', group: 'common' },useAbility: { def: useAbility, id: 'useAbility', group: 'common' },balancedSmite: { def: balancedSmite, id: 'balancedSmite', group: 'paladin' },penance: { def: penance, id: 'penance', group: 'paladin' },shieldsUp: { def: shieldsUp, id: 'shieldsUp', group: 'paladin' },spikedShield: { def: spikedShield, id: 'spikedShield', group: 'paladin' } }
